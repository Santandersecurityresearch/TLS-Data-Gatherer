...
# The purpose of this function is to apply the filters we establish for each 
# Technology in the dictionary.
# NOTE: this function is currently NOT in use but may be useful in the future.
